"""MNIST_Xception.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17NwjVS7vUgvfPqyuCjcFRlaV-L2gJB13
"""
...
inceptionModel = tf.keras.applications.Xception(input_shape=(75,75,3),weights='imagenet', include_top=False)
...
print("\n")
print("Xception Model - Adagrad Optimizer Accuracy - ", incadaval[1]*100)
incadaval
incada.save("mnist_models/xceptionada_model.h5")
...
print("\n")
print("Xception Model - Adagrad Optimizer Accuracy - ", incadamval[1]*100)
incadamval
incadam.save("mnist_models/xceptionadam_model.h5")
...
print("\n")
print("Xception Model - RMSProp Optimizer Accuracy - ", incrmsval[1]*100)
incrmsval
incrms.save("mnist_models/xceptionrms_model.h5")
...
print("\n")
print("Xception Model - SGD Optimizer Accuracy - ", incsgdval[1]*100)
incsgdval
incsgd.save("mnist_models/xceptionsgd_model.h5")
...
# display the plot
plt.savefig("outputs/mnistDataset/xception_optimizer_evaluation.png")
plt.show()
...
plt.savefig("outputs/mnistDataset/xception_training_loss.png")
plt.show()
...
plt.xlabel('Epoch')
plt.legend(['Adam', 'Adagrad','RMSprop','SGD'], loc='upper right')
plt.savefig("outputs/mnistDataset/xception_validation_loss.png")
plt.show()
...
plt.savefig("outputs/mnistDataset/xception_training_accuracy.png")
plt.show()
...
plt.xlabel('Epoch')
plt.legend(['Adam', 'Adagrad','RMSprop','SGD'], loc='lower right')
plt.savefig("outputs/mnistDataset/xception_validation_accuracy.png")
plt.show()
...
plt.savefig("outputs/mnistDataset/xception_val_acc_whiskerplot.png")
plt.show()
